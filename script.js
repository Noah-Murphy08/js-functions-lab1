...
Complete the exercise in the space below:
*/
//https://www.thoughtco.com/celcius-to-farenheit-formula-609227 for temp coversion equation
...
//https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/switch to explain switch syntax and view examples
const basicCalculator = (num1, num2, op) => {
    ...
    case 'divide':
        return num1 / num2;
    default:
        return `please use a given operation.`;
    }
}
...
function numArgs(...theArgs) {
    // let total = 0
    // for (const arg of theArgs) {
    //     total = arg;
    // }
    let total = theArgs.length;
    return total;
}
